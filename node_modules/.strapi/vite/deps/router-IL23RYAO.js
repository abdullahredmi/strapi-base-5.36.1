...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-7V5P6OMF.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-T4UXUX7C.js").then((mod) => ({
...
//# sourceMappingURL=router-IL23RYAO.js.map
